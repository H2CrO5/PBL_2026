...
TRANSLATIONS = {
    ...
    "upload_processing": {"en": "Uploading, extracting, and indexing the material...", "ja": "教材をアップロードし、テキスト抽出と索引化を行っています..."},
    "uploaded": {"en": "Uploaded: {status}", "ja": "アップロード完了: {status}"},
    "student_visible": {"en": "Make this material available to students", "ja": "この教材を学生に公開する"},
    "student_visible_help": {"en": "Turn this off for answer keys, rubrics, and internal teacher notes.", "ja": "模範解答、採点基準、教員用メモはオフにしてください。"},
    "visible_to_students": {"en": "Visible to enrolled students", "ja": "履修中の学生に公開中"},
    "private_to_teacher": {"en": "Teacher only", "ja": "教員のみ"},
    "publish_to_students": {"en": "Publish to students", "ja": "学生に公開"},
    "hide_from_students": {"en": "Hide from students", "ja": "学生への公開を停止"},
    "visibility_updated": {"en": "Student visibility updated.", "ja": "学生への公開設定を更新しました。"},
    "sync_error_detail": {"en": "Indexing failed: {detail}", "ja": "索引化に失敗しました: {detail}"},
