...
TRANSLATIONS = {
    ...
    "question_seeds": {"en": "Assignment Templates", "ja": "課題テンプレート"},
    "seed_total": {"en": "{total} total / {required} required", "ja": "合計 {total}件（必須 {required}件）"},
    ...
    "sync_all_rag": {"en": "Sync all materials to Student RAG", "ja": "すべての教材をStudentのRAGに同期"},
    ...
    "lecture_seeds": {"en": "Lecture Templates", "ja": "課題テンプレート数"},
    ...
    "add_seed": {"en": "Add Assignment Template", "ja": "課題テンプレートを追加"},
    "target_concept": {"en": "Target concept", "ja": "確認する分野"},
    "seed_type": {"en": "Template type", "ja": "テンプレート種別"},
    ...
    "save_seed": {"en": "Save assignment template", "ja": "課題テンプレートを保存"},
    "required_fields": {"en": "Question, expected answer, and rubric are required.", "ja": "問題、模範解答、採点基準は必須です。"},
    "seed_saved": {"en": "Assignment template saved.", "ja": "課題テンプレートを保存しました。"},
    ...
    "candidate_saved": {"en": "Candidate saved as a question seed.", "ja": "候補を課題テンプレートとして保存しました。"},
    "no_seeds": {"en": "No assignment templates for this lecture yet.", "ja": "この講義には課題テンプレートがまだありません。"},
    ...
    "related_seeds": {"en": "Related question seeds", "ja": "関連する課題テンプレート"},
    "no_related_seed": {"en": "No related seed yet", "ja": "関連する課題テンプレートはまだありません"},
    ...
    "recommended_seeds": {"en": "Recommended templates", "ja": "使用を推奨する課題テンプレート"},
...
def localize_text(value: str) -> str:
    ...
    exact = {
        ...
        "Add required question seeds": "必須の課題テンプレートを追加する",
        ...
        "Add at least one required seed for each active lecture.": "各講義に必須の課題テンプレートを1件以上追加してください。",
        ...
        "Required question seed": "必須の課題テンプレート",
        ...
        "Add at least one required seed before backend assignment generation.": "課題を生成する前に、必須の課題テンプレートを1件以上追加してください。",
        ...
        "Keep required seeds locked when shared backend generates assignment variants.": "共有バックエンドが類題を生成する際も、必須の課題テンプレートは変更しないでください。",
    ...
    for line in value.splitlines():
        ...
        if match:
            localized_lines.append(f"必須の課題テンプレート{match.group(1)}件を生成条件として使用します。")
            continue
