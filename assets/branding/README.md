# ClassPilot brand assets

These assets were supplied by the project owner on 2026-08-19 and are used in
...
- `classpilot-favicon.png`: compact purple CP mark with a transparent exterior for Student and Teacher browser tabs.
...
Preferred UI colors are deep purple `#2D0B78` and teal `#14B8B8`.
